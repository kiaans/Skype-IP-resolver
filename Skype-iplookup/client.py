...
PathToLog = "/home/work/Work/skypekit_sdk+runtimes_370_412/skypekit-sdk_runtime-3.7.0/bin/linux-x86/logs/logs20140126-1301.log"


if len(sys.argv) == 1:
        print('Usage: python2 <client_script> <skypename>')
        sys.exit();
